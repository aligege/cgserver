    ...
    async init()
    {
        return new Promise(async (resolve)=>{
            ...
            this._pool  = mysql.createPool({
                connectionLimit : 100,
                host     : GFCfg.db.mysql.host,
                port     : GFCfg.db.mysql.port,
                user     : GFCfg.db.mysql.user,
                password : GFCfg.db.mysql.password,
                database : GFCfg.db.mysql.database,
                supportBigNumbers : true,
                charset:"utf8mb4"
            })
            console.log("mysql config="+JSON.stringify(GFCfg.db.mysql))
