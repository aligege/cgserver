...
{
    protected _ctrs=new Map<string,Map<string,BaseController>>()
    protected _ctr_cls=new Map<string,Map<string,any>>()
    //module ctrname lower normal
    protected _cache_action_names=new Map<string,Map<string,Map<string,string>>>()
    registerController(module_name:string,ctr_name:string,cls:Function)
    {
    ...
    protected _cacheActionName(module_name:string,ctr_name:string,cls:Function)
    {
        ...
        let map_names=new Map<string,string>()
